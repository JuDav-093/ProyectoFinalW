    ...
    for (let i = 0; i < nroRegistros; i++) {
        ...
        if (objConfiguracionGlobal.editar === true || objConfiguracionGlobal.eliminar === true) {
            ...
            if (objConfiguracionGlobal.editar === true) {
                contenido += `<i onclick="Editar(${obj[propiedadID]})" class="btn btn-outline-primary">
            ...
            if (objConfiguracionGlobal.eliminar === true) {
                contenido += `<i onclick="Eliminar(${obj[propiedadID]})" class="btn btn-outline-danger">
...
function Exito(titulo = "Operación realizada con éxito") {
    Swal.fire({
        title: titulo,
        imageUrl: "https://previews.123rf.com/images/krisdog/krisdog1802/krisdog180200041/94909819-un-m%C3%A9dico-de-dibujos-animados-con-bata-blanca-de-laboratorio-con-estetoscopio-mirando-por-encima-de.jpg",
        imageWidth: 260,
        imageHeight: 260,
        draggable: true,
